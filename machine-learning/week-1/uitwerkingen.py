...
def compute_cost(X, y, theta):
    ...
    J = 0  # de totale kost J(0) met de huidige waarden 0
...
def contour_plot(X, y):
    ...
    # YOUR CODE HERE
    for t1_index, theta_0 in enumerate(t1):
        for t2_index, theta_1 in enumerate(t2):
            # nd array [t0, t1]
            ...
            # opslaan in de matrix
            J_vals[t1_index][t2_index] = J
